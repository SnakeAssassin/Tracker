...
// MARK: - Extensions Configure View
extension TrackersCell {
    func configCell(with tracker: Tracker, category: String, isCompletedToday: Bool, completedDays: Int, indexPath: IndexPath) {

        self.trackerId = tracker.id
        self.isCompletedToday = isCompletedToday
        self.indexPath = indexPath
        backView.backgroundColor = UIColor(named: tracker.color)
        doneButton.backgroundColor = UIColor(named: tracker.color)
