...
final class StatisticsViewController: UIViewController {
    ...
    private lazy var titleLabel: UILabel = {
        let label = UILabel()
        label.text = String.localized("tabBar2.title")
    ...
    private lazy var stubImageView: UIImageView = {
        let image = UIImage(named: "Stub statistics")
    ...
    private lazy var stubLabel: UILabel = {
        let label = UILabel()
        label.text = String.localized("statisticsStubLabel.text")
    ...
    private let bestPeriodTextLabel: UILabel = {
        let label = UILabel()
        label.text = String.localized("bestPeriodTextLabel")
        label.textColor = .ypBlack
        label.font = .systemFont(ofSize: 12, weight: .medium)
        label.translatesAutoresizingMaskIntoConstraints = false
        return label
    ...
    private let idealDaysTextLabel: UILabel = {
        let label = UILabel()
        label.text = String.localized("idealDaysTextLabel")
        label.textColor = .ypBlack
        label.font = .systemFont(ofSize: 12, weight: .medium)
        label.translatesAutoresizingMaskIntoConstraints = false
        return label
    ...
    private let trackersCompletedTextLabel: UILabel = {
        let label = UILabel()
        label.text = String.localized("trackersCompletedTextLabel")
        label.textColor = .ypBlack
        label.font = .systemFont(ofSize: 12, weight: .medium)
        label.translatesAutoresizingMaskIntoConstraints = false
        return label
    ...
    private let averageValueTextLabel: UILabel = {
        let label = UILabel()
        label.text = String.localized("averageValueTextLabel")
        label.textColor = .ypBlack
        label.font = .systemFont(ofSize: 12, weight: .medium)
        label.translatesAutoresizingMaskIntoConstraints = false
        return label
    ...
    private func setupConstraints() {
        ...
        fistGradientImageView.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 77),
