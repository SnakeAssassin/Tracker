...
final class TrackerPropertiesCell: UITableViewCell {
    ...
    private let properties = [String.localized("newTraсker.habbit.section1"), String.localized("newTraсker.habbit.section2")]
    private var indexPath: IndexPath?
    
    //MARK: View
    private let propertiesTitleLabel: UILabel = {
        let label = UILabel()
        label.text = String.localized("newTraсker.event.section1")
